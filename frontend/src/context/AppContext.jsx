    ...
    try {
      ...
      if (data.success && Array.isArray(data.products)) {
        ...
        const mapped = data.products.map((p) => ({
          ...
          badge: p.badge || "",
          colors: Array.isArray(p.colors) && p.colors.length > 0 ? p.colors : [{ name: "Default", hex: "#c5a072", image: p.image || "https://placehold.co/400x600?text=No+Image" }],
          ...
          images: Array.isArray(p.images) && p.images.length > 0 ? p.images : p.image ? [p.image] : ["https://placehold.co/400x600?text=No+Image"],
          image: p.image || (Array.isArray(p.images) && p.images.length > 0 ? p.images[0] : "https://placehold.co/400x600?text=No+Image"),
          stock: p.stock || 0,
          sku: p.sku || "",
